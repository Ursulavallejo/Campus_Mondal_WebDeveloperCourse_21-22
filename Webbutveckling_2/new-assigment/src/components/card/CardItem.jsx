    ...
    return (
        <div className={css.grow}>
            <article className='tc bg-washed-yellow br3 pa3 ma2  bw2 shadow-5 '>
                ...
                <div>
                    <h3>{props.artist}</h3>
                    <p className={css.colorChangeP}>Album: {props.album}</p>
                    <p className={css.colorChangeP}>Price: {props.price} Kr</p>
                </div>
                <div>
                    <button className={css.btnBuy} id={props.id} onClick={addNewProductToCartHandler}>Add to Cart
                    </button>
                </div>
            </article>
        </div>
